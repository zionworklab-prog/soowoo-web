    ...
    <div className="flex flex-1 flex-col px-6 sm:px-10">
      <div className="mb-12 mt-auto flex flex-col items-start gap-8 sm:mb-16">
        <Link
          href="/menu"
          aria-label="주류 메뉴 보기"
          className="transition-transform duration-200 hover:scale-105 active:scale-95 motion-safe:animate-fade-rise-in"
        >
          <Image
        ...
        <p className="text-body-small text-muted motion-safe:animate-fade-rise-in-delayed">
